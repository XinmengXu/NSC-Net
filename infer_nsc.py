...
from nsc_net.datas.transform import get_preprocessing_pipelines
from nsc_net.videomodels import ResNetVideoModel
...
if __name__ == '__main__':
    ...
    audiomodel = NSCNet.from_pretrain(checkpoint_path, sample_rate=train_conf["datamodule"]["data_config"]["sample_rate"], **train_conf["audionet"]["audionet_config"])
